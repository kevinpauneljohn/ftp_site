        ...
        <div class="box-body">
            <form role="form" method="post" action="{{route('job.orders.create')}}">
                @if(session('success') == true)
                    <div class="alert alert-success">Job Order Successfully Updated!</div>
                @endif
                @csrf
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group {{$errors->has('title') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="title" class="form-control" value="{{old('title')?:$jobOrder->title}}" />
                            @error('title')
                        ...
                        <div class="form-group description {{$errors->has('description') ? 'has-error' : ''}}">
                            ...
                            <textarea name="description" id="description" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                {{old('description')?:$jobOrder->description}}
                            </textarea>
                        ...
                        <div class="form-group {{$errors->has('category') ? 'has-error' : ''}}">
                            ...
                            <select name="category" class="form-control">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{$category->id}}"  @if ($jobOrder->category_id == $category->id) {{ 'selected' }} @endif>{{$category->name}}</option>
                                @endforeach
                            </select>
                            @error('category')
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{$errors->has('customer_name') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="customer_name" value="{{old('customer_name')?:$jobOrder->customer_name}}" class="form-control" id="customer_name" />
                            @error('customer_name')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group {{$errors->has('contact_number') ? 'has-error' : ''}}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contact_number" class="form-control" data-inputmask='"mask": "(9999) 999-9999"' data-mask value="{{old('contact_number')?:$jobOrder->customer_contact_number}}">
                            </div>
                        ...
                        <div class="form-group {{$errors->has('pickup_date') ? 'has-error' : ''}}">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" name="pickup_date" class="form-control pull-right" id="datepicker" value="{{old('pickup_date')?:$jobOrder->pickup_date}}">
                            </div>
                            <!-- /.input group -->
                            @error('pickup_date')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="bootstrap-timepicker">
                            <div class="form-group {{$errors->has('pickup_time') ? 'has-error' : ''}}">
                                ...
                                <div class="input-group">
                                    <input type="text" name="pickup_time" class="form-control timepicker" value="{{old('pickup_time')?:$jobOrder->pickup_time}}">
                        ...
                        <div class="form-group {{$errors->has('amount') ? 'has-error' : ''}}">
                            ...
                            <input type="number" name="amount" class="form-control" value="{{old('amount') ?: $jobOrder->amount}}"  step="0.01" min="0"/>
                            @error('amount')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group {{$errors->has('down_payment') ? 'has-error' : ''}}">
                            ...
                            <input type="number" name="down_payment" class="form-control" value="{{old('down_payment') ?: $jobOrder->down_payment}}"  step="0.01" min="0" />
                            @error('down_payment')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
